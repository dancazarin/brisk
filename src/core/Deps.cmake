...
target_link_libraries(brisk-core ${_DEP_PRIVATE} ${LibTomCrypt_LIBRARIES})
target_include_directories(brisk-core ${_DEP_PRIVATE} ${LibTomCrypt_INCLUDE_DIR})
# /libtomcrypt

# >libtommath
find_library(LibTomMath_LIBRARIES tommath)
target_link_libraries(brisk-core ${_DEP_PRIVATE} ${LibTomMath_LIBRARIES})
# /libtommath
