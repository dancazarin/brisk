...
class StyleLength {
 public:
  ...
  constexpr static StyleLength pointsUnsafe(float value) {
    return StyleLength{FloatOptional{value}, Unit::Point};
  }
  ...
  constexpr static StyleLength percentUnsafe(float value) {
    return StyleLength{FloatOptional{value}, Unit::Percent};
  }
