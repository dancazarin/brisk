...
std::array<KeyCode, numScanCodes> scanCodeToKeyCodeTable{};
std::array<int16_t, numKeyCodes> keyCodeToScanCodeTable{};
...
char32_t keySym2Unicode(KeySym keysym) {
    int min = 0;
    int max = std::size(keysymtab) - 1;
    int mid;
